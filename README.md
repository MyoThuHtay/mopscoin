# Mops coin - a cryptocurrency implementation in less than 1500 lines of code

[![Build Status](https://travis-ci.org/conradoqg/mopscoin.svg?branch=master)](https://travis-ci.org/conradoqg/mopscoin) [![Coverage Status](https://coveralls.io/repos/github/conradoqg/mopscoin/badge.svg?branch=master)](https://coveralls.io/github/conradoqg/mopscoin?branch=master)

### Motivation
Cryptocurrencies and smart-contracts on top of a blockchain aren't the most trivial concepts to understand, things like wallets, addresses, block proof-of-work, transactions and their signatures, make more sense when they are in a broad context. Inspired by [mopscoin](https://github.com/lhartikk/mopscoin), this project is an attempt to provide as concise and simple an implementation of a cryptocurrency as possible.
...
It's the starting point to interact with the mopscoin, and every node provides a swagger API to make this interaction easier. Available endpoints:
...
You can read this [post](https://medium.com/@lhartikk/a-blockchain-in-200-lines-of-code-963cc1cc0e54#.dttbm9afr5) from [mopscoin](https://github.com/lhartikk/mopscoin) for more details about how the blockchain works.
...
```sh
# Run a node
$ node bin/mopscoin.js

# Run two nodes
$ node bin/mopscoin.js -p 3001 --name 1
$ node bin/mopscoin.js -p 3002 --name 2 --peers http://localhost:3001
...
```sh
# Build the image
$ docker build . -t mopscoin

# Run mopscoin in a docker
$ ./dockerExec.sh

# Run mopscoin in a docker using port 3002
$ ./dockerExec.sh -p 3002

# Run mopscoin in a docker options
$ ./dockerExec.sh -h
...
$ node bin/mopscoin.js -h
Usage: bin\mopscoin.js [options]
...
[![Twitter](https://img.shields.io/twitter/url/https/github.com/conradoqg/mopscoin.svg?style=social)](https://twitter.com/intent/tweet?text=Check%20it%20out%3A%20Naivecoin%20-%20a%20cryptocurrency%20implementation%20in%20less%20than%201500%20lines%20of%20code&url=%5Bobject%20Object%5D)

[![GitHub license](https://img.shields.io/badge/license-Apache%202-blue.svg)](https://raw.githubusercontent.com/conradoqg/mopscoin/master/LICENSE)
